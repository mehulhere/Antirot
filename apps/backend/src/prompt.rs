...
pub fn build_coach_system_prompt(context: PromptContext) -> BuiltPrompt {
    ...
    prompt.push_str("- An early stop is not proof of dishonesty. Ask what happened and what time was genuinely productive without accusing the user of clicking out, faking work, or lying.\n");
