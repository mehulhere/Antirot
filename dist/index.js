...
import { appendBehaviorEntry, appendEvent, appendLongtermEntry, appendShorttermEntry, appendWeeklyOverrideEntry, appendWorkEntry, ensureWorkspace, getDailySummaryName, getDailyWorkLogName, nowIso, readState, readStats, readStrategyPerformance, readTextIfExists, resolveWorkspaceDir, todayKey, writeState, writeStats, writeStrategyPerformance, writeWorkspaceTextFile } from "./storage.js";
    ...
    api.registerTool((ctx) => ({
        ...
        async execute(_toolCallId, params) {
            ...
            if (activeTaskTitles.length > 0) {
                ...
                if (!matchedTask) {
                    return textResult(`Error: task_id "${taskId}" does not match any active task in tasks.md.\n` +
